...
const DEFAULT_OPTION_TITLES = ['复制文本', '取消']
...
export interface BubbleProps<TMessage extends IMessage> {
  ...
  renderSendStateView?(): React.ReactNode
...
> extends React.Component<BubbleProps<TMessage>> {
  ...
  static propTypes = {
    ...
    renderSendStateView: PropTypes.func,
  ...
  renderMessageText() {
    if (this.props.currentMessage && this.props.currentMessage.text) {
      ...
      if (this.props.renderMessageText) {
        return this.props.renderMessageText(TextProps)
      }
  ...
  render() {
    ...
    return (
      ...
      >
        <View style={styles[position].container1}>
          {this.props.position === 'right' ? (this.props.renderSendStateView(this.props)) : null}
          <View
            style={[
